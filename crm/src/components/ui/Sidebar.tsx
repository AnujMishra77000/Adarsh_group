...
const navItems: NavItem[] = [
  ...
  { to: CRM_PATHS.sharedChat, label: "Shop Chat", shortLabel: "Chat", icon: MessageSquare },
  { to: CRM_PATHS.campaigns, label: "Campaigns", shortLabel: "Camp", icon: Megaphone },
  { to: CRM_PATHS.analytics, label: "Analytics", shortLabel: "Chart", icon: BarChart3, roles: ["admin"] },
  { to: CRM_PATHS.staffManagement, label: "Staff", shortLabel: "Staff", icon: UserCog, roles: ["admin"] }
];
