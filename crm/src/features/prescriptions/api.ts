...
export async function openPrescriptionPdf(prescriptionId: number): Promise<void> {
  const response = await apiClient.get<Blob>(`/prescriptions/${prescriptionId}/pdf/download`, {
    responseType: "blob"
  });
