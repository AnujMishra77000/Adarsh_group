...
import { getAuthConfig } from "@/features/auth/api";
...
export function LandingPage() {
  ...
  const visibleActions = actions.filter((item) => !item.requiresRegistrationEnabled || adminRegistrationEnabled);
